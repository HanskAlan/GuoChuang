...
public class PacketParsing {
    ...
    /**
     * start position of str_buffer in array
     */
    private static final int STR_BUFFER_START_POSITION = 42;

    /**
     * end position of str_buffer in array
     */
    private static final int STR_BUFFER_END_POSITION = 200;
     ...
     * @return strInfo
     */
    public static byte[] extractStrInfo(final byte[] payload){
        return Arrays.copyOfRange(payload, STR_BUFFER_START_POSITION, STR_BUFFER_END_POSITION);
    }
