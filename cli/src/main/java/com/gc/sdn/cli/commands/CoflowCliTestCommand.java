 ...
 */
package com.gc.sdn.cli.commands;
...
public class CoflowCliTestCommand extends AbstractAction {

    private static final Logger LOG = LoggerFactory.getLogger(CoflowCliTestCommand.class);
    protected final CoflowCliCommands service;

    public CoflowCliTestCommand(final CoflowCliCommands service) {
